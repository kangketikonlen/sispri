...
<script>
	$(document).ready(function() {
		var url = "<?= base_url('indikator/pasien_covid/get_jumlah?') ?>";
		var urlChart = "<?= base_url('indikator/pasien_covid/chart_data?') ?>";
		var urlTable = "<?= base_url('indikator/pasien_covid/get_table?') ?>";
		// 
