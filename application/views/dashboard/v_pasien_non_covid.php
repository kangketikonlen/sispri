<div class="row">
	<div class="col-12">
		...
		<div class="row">
			<?php $this->load->view('dashboard/components/pasien_non_covid/c_poli') ?>
		</div>
		<div class="row">
			<?php $this->load->view('dashboard/components/pasien_non_covid/c_table') ?>
			<?php $this->load->view('dashboard/components/pasien_non_covid/c_chart') ?>
		</div>
	</div>
</div>
<script>
