<div class="row">
	<div class="col-12">
		...
		<div class="row">
			<?php $this->load->view('dashboard/components/kunjungan_pasien/c_poli') ?>
		</div>
		<div class="row">
			<?php $this->load->view('dashboard/components/kunjungan_pasien/c_table') ?>
			<?php $this->load->view('dashboard/components/kunjungan_pasien/c_chart') ?>
		</div>
	</div>
</div>
<script>
