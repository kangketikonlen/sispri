<div class="row">
	<div class="col-12">
		...
		<div class="row">
			<?php $this->load->view('dashboard/components/bor/c_ruangan') ?>
		</div>
		<div class="row">
			<?php $this->load->view('dashboard/components/bor/c_table') ?>
			<?php $this->load->view('dashboard/components/bor/c_chart') ?>
		</div>
	</div>
</div>
<script>
