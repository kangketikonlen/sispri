<div class="row">
	<div class="col-12">
		...
		<div class="row">
			<?php $this->load->view('dashboard/components/gdr/c_ruangan') ?>
		</div>
		<div class="row">
			<?php $this->load->view('dashboard/components/gdr/c_table') ?>
			<?php $this->load->view('dashboard/components/gdr/c_chart') ?>
		</div>
	</div>
</div>
<script>
