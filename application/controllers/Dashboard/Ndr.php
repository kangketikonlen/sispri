	...
	public function chart_data()
	{
		...
		foreach ($poli as $lists) {
			$dataset[] = array(
				...
				'pointRadius' => false,
				'data' => array(rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25), rand(0, 25)),
			);
		}
